...
export function MaterialSymbolsBubbleChartOutlineRounded(
...
export function FluentHome12Regular(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function MaterialSymbolsLightCloseSmallOutlineRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function MaterialSymbolsPhoneEnabledSharp(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="M4.05 21H3v-5.875L8 14.1l2.9 2.9q1-.575 1.863-1.237t1.587-1.388q.775-.75 1.45-1.625t1.225-1.85l-2.85-2.875L15.1 3H21v1.05q0 3.15-1.35 6.2T15.8 15.8t-5.562 3.85T4.05 21"
      ></path>
    </svg>
  );
}
...
export function MaterialSymbolsPersonRaisedHand(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function MaterialSymbolsWifiRounded(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function MaterialSymbolsLightVisibilityRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function MaterialSymbolsLightEdit(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M4 20v-2.52L17.18 4.288q.154-.137.34-.212T17.907 4t.39.063t.35.23l1.066 1.072q.166.16.226.35t.061.382q0 .203-.069.389t-.218.339L6.52 20zM17.504 7.588L19 6.112L17.888 5l-1.476 1.496z"
      ></path>
    </svg>
  );
}

export function MaterialSymbolsLightDeleteForever(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="m9.4 15.808l2.6-2.6l2.6 2.6l.708-.708l-2.6-2.6l2.6-2.6l-.708-.708l-2.6 2.6l-2.6-2.6l-.708.708l2.6 2.6l-2.6 2.6zM7.615 20q-.69 0-1.152-.462T6 18.385V6H5V5h4v-.77h6V5h4v1h-1v12.385q0 .69-.462 1.152T16.385 20z"
      ></path>
    </svg>
  );
}

export function MaterialSymbolsHeadsetMicOutlineRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function SystemUiconsUserAdd(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      >
        <path d="M10.5 2.5a3 3 0 0 1 3 3v2a3 3 0 1 1-6 0v-2a3 3 0 0 1 3-3m7 2v4m2-2h-4"></path>
        <path d="M17.5 16.5v-.728c0-3.187-3.686-5.272-7-5.272s-7 2.085-7 5.272v.728a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1"></path>
      </g>
    </svg>
  );
}

export function SystemUiconsUserMale(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function SystemUiconsBook(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function SystemUiconsBell(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function MaterialSymbolsLightFeatureSearchOutline(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function FluentSend16Regular(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
