            ...
            <Table className="">
                <TableHeader>
                    <TableRow className=" bg-zinc-100">
                        ...
                        <TableHead className="font-bold text-base text-center">Id details/Status</TableHead>
                        <TableHead className="font-bold text-base text-center">Account holder</TableHead>
                        <TableHead className="font-bold text-base text-left">Account number</TableHead>
                        <TableHead className="font-bold text-base text-left">Mobile</TableHead>
                        <TableHead className="font-bold text-base text-left">Gateway</TableHead>
                        <TableHead className="font-bold text-base text-left">Bank details</TableHead>
                        <TableHead className="font-bold text-base text-left">UPI details</TableHead>
                        <TableHead className="font-bold text-base text-left">QR code</TableHead>
                        <TableHead className="font-bold text-base text-left">Action</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {tableValues.map((value, index) => (
                        <TableRow className="">
                            ...
                            <TableCell className="flex gap-2 items-center flex-col">
                                ...
                                <div className='font-semibold text-sm'>User Id:{value.idOrStatus?.userId}</div>
                                {
                                    value.idOrStatus?.status === 'Active'
                                        ? <Tag className='w-20 flex justify-center' color="green">Active</Tag>
                                        : <Tag className='w-20 flex justify-center' color="red">Inactive</Tag>
                                }
                            </TableCell>
                            ...
                            <TableCell >
                                {
                                    value.bankDetails.show
                                        ? <>
                                            <div className='text-sm font-semibold'>Bank: {value.bankDetails.bankName}</div>
                                            <div className='text-sm font-semibold'>AC: {value.bankDetails.accountAc}</div>
                                            <div className='text-sm font-semibold'>AC holder: {value.bankDetails.accountHolderName}</div>
                                            <div className='text-sm font-semibold'>IFCE: {value.bankDetails.ifce}</div>
                            ...
                            <TableCell>
                                <Button onClick={value.action} className='bg-green-500 hover:bg-green-900 py-1 px-2 text-xs'>Gateways</Button>
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
...
const tableValues = [
    ...
    },
    {
        ...
        qr: <img className='w-10' src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/QR_code_for_mobile_English_Wikipedia.svg/800px-QR_code_for_mobile_English_Wikipedia.svg.png" alt="" />,
        action: function () { }
    },
    {
        no: 1,
