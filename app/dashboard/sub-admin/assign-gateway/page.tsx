...
const AssignGateWaysPage = () => {
    return (
        <div className='flex flex-col items-start justify-start w-full'>
            ...
            <div className="flex sm:flex-row w-[20%] flex-col items-start justify-start">
            ...
            {/* ----------- search result ----------- */}
            <div className="flex flex-col w-[50%] px-4  my-3 mt-3 items-center justify-start gap-3">
                {/* ...... input ..... */}
