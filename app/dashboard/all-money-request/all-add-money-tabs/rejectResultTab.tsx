                        ...
                        return <div className="flex bg-gray-50 shadow-md flex-col justify-start items-center w-[360px] p-0 rounded-lg">
                            ...
                            <div className="flex justify-between px-4 py-2 w-full">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex gap-3 items-center" > <CiCreditCard2 /> <span className="font-semibold text-sm">  Ref no: </span> A7238912IDA</div>
                                    <div className="flex gap-3 items-center" > <FaRegCalendar /> <span className="font-semibold text-sm">  29/05/2005 </span></div>
                                    <div className="flex gap-3 mt-3 items-center" > <FaArrowRight  /> <span className="font-semibold text-sm text-red-500">  reason of rejection </span></div>
                                </div>
                            ...
                            <div className="  w-full flex items-center justify-end">
                                <Tag className="w-full  text-center p-0 m-0 py-[2px]" color="red">Rejected</Tag>
                            </div>
                        </div>
                    })
                }
