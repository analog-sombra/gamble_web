                    ...
                    players.map((user: Players) => {
                        return <div className="flex bg-gray-50 shadow-md flex-col justify-start items-center w-[360px] p-0 rounded-lg">
                            ...
                            <div className="flex justify-end w-center">
                                <span className='text-start ml-[150px] justify-self-end text-green-500 font-bold '>Approved</span>
                            </div>
                            <div className="flex w-full px-5 mt-4 justify-start gap-4">
                                <Input className="rounded-3xl " id="picture" type="text" placeholder="Type refund" />
                                <Button className="rounded-3xl text-xs flex justify-self-start bg-[#4ca091] px-3 ">Refund now</Button>
                            </div>
                            ...
                            <div className="min-h-7  w-full flex items-center justify-end">
                                <Tag className="w-full text-center p-0 m-0 py-[2px]" color="green">Approved</Tag>
                            </div>
                        </div>
                    })
                }
