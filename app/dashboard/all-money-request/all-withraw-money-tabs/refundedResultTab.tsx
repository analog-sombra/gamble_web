                    ...
                    players.map((user: Players) => {
                        return <div className="flex bg-gray-50 shadow-md flex-col justify-start items-center w-[360px] p-0 rounded-lg">
                            ...
                            <div className="flex item-start px-6 mb-0 mt-6 w-full justify-center gap-1 flex-col">
                                <span className='text-start  justify-self-end text-yellow-600 font-bold'>Refunded 7/23/2024:-</span>
                            </div>
                            ...
                            <div className="min-h-7  w-full flex items-center justify-end">
                                <Tag className="w-full text-center p-0 m-0 py-[2px]" color="gold">Refunded</Tag>
                            </div>
                        </div>
                    })
                }
