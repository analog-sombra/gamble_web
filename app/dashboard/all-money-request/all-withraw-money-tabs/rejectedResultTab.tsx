                    ...
                    players.map((user: Players) => {
                        return <div className="flex bg-gray-50 shadow-md flex-col justify-start items-center w-[360px] p-0 rounded-lg">
                            ...
                            <div className="flex item-start px-6 mb-2 mt-6 w-full justify-center gap-1 flex-col">
                                <span className='text-start  justify-self-end text-red-600 font-bold '>Rejected on 7/23/2024:-</span>
                                <span className='text-red-500 font-semibold text-[13px]'>Reason of being rejected here</span>
                            </div>
