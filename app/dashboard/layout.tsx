          ...
          <div className=" mb-3 flex flex-col bg-[#341c8c] xp-4 px-6 py-3 rounded-md">
            <div className="flex mb-4 justify-between">
              <div className="flex items-center space-x-2">
                <Label htmlFor="toggle-add" className="text-white">
                  Add
                </Label>
              ...
              <div className="grow"></div>
              <div className="flex items-center space-x-2">
                <Label htmlFor="toggle-withdraw" className="text-white">
                  Withdraw
                </Label>
            ...
            <div className="flex justify-between items-center ">
              <button
                className="bg-transparent px-2 rounded-md hover:bg-[#4b30b0]"
